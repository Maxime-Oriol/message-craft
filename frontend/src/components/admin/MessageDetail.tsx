        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    {message.intent && (
                        <div>
                            <h4 className="font-semibold text-sm text-muted-foreground mb-2">Intention utilisateur</h4>
                            <p className="text-sm bg-muted p-3 rounded-md">{message.intent}</p>
                        </div>
                    )}
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            <h4 className="font-semibold text-sm text-muted-foreground">Message anonymisé</h4>
                        </div>
                        <div className="bg-card border rounded-lg p-4">
                            <p className="text-sm leading-relaxed whitespace-pre-wrap">{message.piiMessage}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                            <div className="bg-muted p-3 rounded-md text-center border border-outline">
                                <p className="text-xs text-muted-foreground">Pii factor</p>
                                <p className="text-lg font-semibold">
                                    {(message.piiScore * 100).toFixed(1)}%
                                </p>
                            </div>
                            <div className="bg-muted p-3 rounded-md text-center border border-outline">
